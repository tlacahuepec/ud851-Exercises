...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {// && savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY) != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String lifeCycles = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(lifeCycles);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String lifeCycles = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, lifeCycles);
    }
