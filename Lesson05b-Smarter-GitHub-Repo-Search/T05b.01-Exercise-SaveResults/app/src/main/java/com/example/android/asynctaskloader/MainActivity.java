...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_STORE_JSON = "KEY_STORE_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(KEY_STORE_JSON) && savedInstanceState.containsKey(KEY_QUERY_URL)) {
                String raw_json = savedInstanceState.getString(KEY_STORE_JSON);
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putString(KEY_QUERY_URL, url);
        ...
        bundle.putString(KEY_STORE_JSON, raw_json);
    }
}